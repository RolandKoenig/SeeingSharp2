...
namespace SeeingSharp.Mathematics
{
    ...
    public struct Half3 : IEquatable<Half3>
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="System.Numerics.Vector3"/> to <see cref="Half3"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Half3"/> to <see cref="System.Numerics.Vector3"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.Numerics.Vector2"/> to <see cref="Half3"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="Half3"/> to <see cref="System.Numerics.Vector2"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
