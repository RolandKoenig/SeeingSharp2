...
namespace SeeingSharp.Mathematics
{
    ...
    public partial struct RectangleF : IEquatable<RectangleF>
    {
        ...
        /// <summary>
        /// Checks, if specified <see cref="System.Numerics.Vector2"/> is inside <see cref="RectangleF"/>. 
        /// </summary> 
        /// <param name="vector2D">Coordinate <see cref="System.Numerics.Vector2"/>.</param>
        /// <returns><c>true</c> if <see cref="System.Numerics.Vector2"/> is inside <see cref="RectangleF"/>, otherwise <c>false</c>.</returns>
