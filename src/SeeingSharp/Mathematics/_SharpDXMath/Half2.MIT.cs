...
namespace SeeingSharp.Mathematics
{
    ...
    public struct Half2 : IEquatable<Half2>
    {
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="System.Numerics.Vector2"/> to <see cref="Half2"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="Half2"/> to <see cref="System.Numerics.Vector2"/>.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns>The result of the conversion.</returns>
