...
namespace SeeingSharp.Util.Sdx
{
    ...
    internal class DataStream : Stream
    {
        ...
        public void Read(IntPtr buffer, int offset, int count)
        {
            unsafe
            {
                SdxUtilities.CopyMemory(new IntPtr((byte*)buffer + offset), (IntPtr)(_buffer + _position), count);
                _position += count;
            }
        }
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref="DataStream"/> to <see cref="DataPointer"/>.
        /// </summary>
