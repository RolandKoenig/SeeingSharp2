...
namespace SeeingSharp.Multimedia.Core
{
    ...
    public class SceneRelatedUpdateState : IAnimationUpdateState
    {
        ...
        internal void OnStartSceneUpdate(Scene targetScene, UpdateState updateState, IEnumerable<InputFrame> inputFrames)
        {
            ...
            if (InputFrames == null) { InputFrames = DUMMY_FRAME_COLLECTION; }
        }
        ...
        public TimeSpan UpdateTime
        {
            get
            {
                ...
                if (IsPaused && (!IgnorePauseState)) { return TimeSpan.Zero; }
        ...
        public int UpdateTimeMilliseconds
        {
            get
            {
                ...
                if (IsPaused && (!IgnorePauseState)) { return 0; }
        ...
        /// </summary>
        public IEnumerable<InputFrame> InputFrames { get; private set; }
