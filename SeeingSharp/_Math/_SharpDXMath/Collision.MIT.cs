...
namespace SeeingSharp
{
    ...
    */
    ...
    public static class Collision
    {
        ...
        /// <summary>
        /// Determines the closest point between a <see cref="SeeingSharp.Plane"/> and a point.
        /// </summary>
        ...
        /// <summary>
        /// Determines the closest point between a <see cref="SeeingSharp.BoundingBox"/> and a point.
        /// </summary>
        ...
        /// <summary>
        /// Determines the closest point between a <see cref="SeeingSharp.BoundingSphere"/> and a point.
        /// </summary>
        ...
        /// <summary>
        /// Determines the closest point between a <see cref="SeeingSharp.BoundingSphere"/> and a <see cref="SeeingSharp.BoundingSphere"/>.
        /// </summary>
        ...
        /// <summary>
        /// Determines the distance between a <see cref="SeeingSharp.Plane"/> and a point.
        /// </summary>
        /// <param name="plane">The plane to test.</param>
        /// <param name="point">The point to test.</param>
        ...
        /// <summary>
        /// Determines the distance between a <see cref="SeeingSharp.BoundingBox"/> and a point.
        /// </summary>
        /// <param name="box">The box to test.</param>
        /// <param name="point">The point to test.</param>
        /// <returns>The distance between the two objects.</returns>
        ...
        /// <summary>
        /// Determines the distance between a <see cref="SeeingSharp.BoundingBox"/> and a <see cref="SeeingSharp.BoundingBox"/>.
        /// </summary>
        ...
        /// <summary>
        /// Determines the distance between a <see cref="SeeingSharp.BoundingSphere"/> and a point.
        /// </summary>
        ...
        /// <summary>
        /// Determines the distance between a <see cref="SeeingSharp.BoundingSphere"/> and a <see cref="SeeingSharp.BoundingSphere"/>.
        /// </summary>
        /// <param name="sphere1">The first sphere to test.</param>
        /// <param name="sphere2">The second sphere to test.</param>
        /// <returns>The distance between the two objects.</returns>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.Ray"/> and a point.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.Ray"/> and a <see cref="SeeingSharp.Ray"/>.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.Ray"/> and a <see cref="SeeingSharp.Plane"/>.
        /// </summary>
        /// <param name="ray">The ray to test.</param>
        /// <param name="plane">The plane to test.</param>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.Ray"/> and a triangle.
        /// </summary>
        /// <param name="ray">The ray to test.</param>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.Ray"/> and a <see cref="SeeingSharp.BoundingBox"/>.
        /// </summary>
        /// <param name="ray">The ray to test.</param>
        /// <param name="box">The box to test.</param>
        /// <param name="distance">When the method completes, contains the distance of the intersection,
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.Ray"/> and a <see cref="SeeingSharp.BoundingSphere"/>.
        /// </summary>
        /// <param name="ray">The ray to test.</param>
        /// <param name="sphere">The sphere to test.</param>
        /// <param name="distance">When the method completes, contains the distance of the intersection,
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.Plane"/> and a point.
        /// </summary>
        /// <param name="plane">The plane to test.</param>
        /// <param name="point">The point to test.</param>
        /// <returns>Whether the two objects intersected.</returns>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.Plane"/> and a <see cref="SeeingSharp.Plane"/>.
        /// </summary>
        ...
        /// as a <see cref="SeeingSharp.Ray"/>, or a zero ray if there was no intersection.</param>
        /// <returns>Whether the two objects intersected.</returns>
        /// <remarks>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.Plane"/> and a triangle.
        /// </summary>
        /// <param name="plane">The plane to test.</param>
        /// <param name="vertex1">The first vertex of the triangle to test.</param>
        /// <param name="vertex2">The second vertex of the triagnle to test.</param>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.Plane"/> and a <see cref="SeeingSharp.BoundingBox"/>.
        /// </summary>
        /// <param name="plane">The plane to test.</param>
        /// <param name="box">The box to test.</param>
        /// <returns>Whether the two objects intersected.</returns>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.Plane"/> and a <see cref="SeeingSharp.BoundingSphere"/>.
        /// </summary>
        /// <param name="plane">The plane to test.</param>
        /// <param name="sphere">The sphere to test.</param>
        /// <returns>Whether the two objects intersected.</returns>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.BoundingBox"/> and a triangle.
        /// </summary>
        /// <param name="box">The box to test.</param>
        /// <param name="vertex1">The first vertex of the triangle to test.</param>
        /// <param name="vertex2">The second vertex of the triagnle to test.</param>
        ...
        */
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.BoundingBox"/> and a <see cref="SeeingSharp.BoundingBox"/>.
        /// </summary>
        /// <param name="box1">The first box to test.</param>
        /// <param name="box2">The second box to test.</param>
        /// <returns>Whether the two objects intersected.</returns>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.BoundingBox"/> and a <see cref="SeeingSharp.BoundingSphere"/>.
        /// </summary>
        /// <param name="box">The box to test.</param>
        /// <param name="sphere">The sphere to test.</param>
        /// <returns>Whether the two objects intersected.</returns>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.BoundingSphere"/> and a triangle.
        /// </summary>
        /// <param name="sphere">The sphere to test.</param>
        /// <param name="vertex1">The first vertex of the triangle to test.</param>
        /// <param name="vertex2">The second vertex of the triagnle to test.</param>
        ...
        /// <summary>
        /// Determines whether there is an intersection between a <see cref="SeeingSharp.BoundingSphere"/> and a <see cref="SeeingSharp.BoundingSphere"/>.
        /// </summary>
        ...
        /// <summary>
        /// Determines whether a <see cref="SeeingSharp.BoundingBox"/> contains a point.
        /// </summary>
        /// <param name="box">The box to test.</param>
        /// <param name="point">The point to test.</param>
        ...
        /* This implentation is wrong
        /// <summary>
        /// Determines whether a <see cref="SeeingSharp.BoundingBox"/> contains a triangle.
        /// </summary>
        /// <param name="box">The box to test.</param>
        /// <param name="vertex1">The first vertex of the triangle to test.</param>
        /// <param name="vertex2">The second vertex of the triagnle to test.</param>
        ...
        */
        ...
        /// <summary>
        /// Determines whether a <see cref="SeeingSharp.BoundingBox"/> contains a <see cref="SeeingSharp.BoundingBox"/>.
        /// </summary>
        /// <param name="box1">The first box to test.</param>
        /// <param name="box2">The second box to test.</param>
        /// <returns>The type of containment the two objects have.</returns>
        ...
        /// <summary>
        /// Determines whether a <see cref="SeeingSharp.BoundingBox"/> contains a <see cref="SeeingSharp.BoundingSphere"/>.
        /// </summary>
        /// <param name="box">The box to test.</param>
        /// <param name="sphere">The sphere to test.</param>
        /// <returns>The type of containment the two objects have.</returns>
        ...
        /// <summary>
        /// Determines whether a <see cref="SeeingSharp.BoundingSphere"/> contains a point.
        /// </summary>
        /// <param name="sphere">The sphere to test.</param>
        /// <param name="point">The point to test.</param>
        /// <returns>The type of containment the two objects have.</returns>
        ...
        /// <summary>
        /// Determines whether a <see cref="SeeingSharp.BoundingSphere"/> contains a triangle.
        /// </summary>
        /// <param name="sphere">The sphere to test.</param>
        /// <param name="vertex1">The first vertex of the triangle to test.</param>
        /// <param name="vertex2">The second vertex of the triagnle to test.</param>
        ...
        /// <summary>
        /// Determines whether a <see cref="SeeingSharp.BoundingSphere"/> contains a <see cref="SeeingSharp.BoundingBox"/>.
        /// </summary>
        /// <param name="sphere">The sphere to test.</param>
        /// <param name="box">The box to test.</param>
        /// <returns>The type of containment the two objects have.</returns>
        ...
        /// <summary>
        /// Determines whether a <see cref="SeeingSharp.BoundingSphere"/> contains a <see cref="SeeingSharp.BoundingSphere"/>.
        /// </summary>
        /// <param name="sphere1">The first sphere to test.</param>
        /// <param name="sphere2">The second sphere to test.</param>
        /// <returns>The type of containment the two objects have.</returns>
