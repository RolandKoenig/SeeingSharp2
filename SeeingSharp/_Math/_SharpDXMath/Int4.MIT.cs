...
namespace SeeingSharp
{
    ...
    public struct Int4 : IEquatable<Int4>, IFormattable
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="int"/> array to <see cref="SeeingSharp.Int4"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="SeeingSharp.Int4"/> to <see cref="System.Int32"/> array.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns>The result of the conversion.</returns>
